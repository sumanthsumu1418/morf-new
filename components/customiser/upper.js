...
import { upperData } from "lib/data";
import useMediaQuery from "../../hooks/useMediaQuery";

const Upper = ({ index, setIndex, state, handleColorClick }) => {
  ...
  return (
    <div className="accordionWrapper">
      ...
      <div
        ref={plane}
        className={`panel colorAndMaterial ${"UPPER" === index && "padding"}`}
        style={{
          maxHeight:
            "UPPER" === index ? `${plane?.current?.scrollHeight}px` : "0px",
        }}
      >
        {/* <div className={`panelMainContainer`}> */}
        {upperData.map((e, index) => {
          return (
                        ...
                        >
                          <div
                            ...
                            style={{
                              background: `#${x.value}`,
                              boxShadow:
                                state.currentUpper.name === x.name &&
                                state.currentUpper.category === x.category
