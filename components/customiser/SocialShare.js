...
const SocialShare = ({ onClose, addToCartData }) => {
    ...
    <div className="resetCustomiser">
      <div className="resetCustomiser__Container">
        ...
        <div
          ...
          className="resetCustomiser__Container__resetBottom resetCustomiser__Container__shareBottom"
        >
          <div className="socialShare-items">
            <a
              href={`https://www.facebook.com/sharer/sharer.php?u=${window.location.origin}/customiser?shoe_design=${joinArray}`}
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href={`https://www.linkedin.com/shareArticle?mini=true&url=${window.location.origin}/customiser?shoe_design=${joinArray}&title=&summary=&source=`}
              target="_blank"
              rel="noreferrer"
              className="socialShare-items-one"
            >
            ...
            <a
              href={`https://wa.me/?text=${window.location.origin}/customiser?shoe_design=${joinArray}`}
              className="socialShare-items-one"
            >
              <svg
                className="socialIcon"
            ...
            <a
              href={`https://twitter.com/intent/tweet?text=${window.location.origin}/customiser?shoe_design=${joinArray}`}
              target="_blank"
              rel="noreferrer"
              className="socialShare-items-one"
            >
            ...
            <div
              onClick={() => {
                copyTextToClipboard(
                  `${window.location.origin}/customiser?shoe_design=${joinArray}`
                );
                onClose();
              }}
              className="socialShare-items-one"
