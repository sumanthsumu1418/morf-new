...
const AddNewAddress = ({ handlestate }) => {
  ...
  return (
    <div className="AddressCheckoutDetails2">
      <p className="mob_cheakout">Checkout</p>
      ...
      <p className="top">
        <span>Welcome </span>
        <span style={{textTransform:"capitalize",color:"black"}}>{user?.firstName}</span>. Please add an address to proceed.
      </p>
      ...
      <div className="detailsBody">
        <div className="First">
          ...
          >
            ...
            <p
              style={{ color: addressType === "PERSONAL" ? "#000" : "#9B9B9B" }}
            >
              PERSONAL
            </p>
          </div>
          ...
          >
            ...
            <p
              style={{ color: addressType === "COMPANY" ? "#000" : "#9B9B9B" }}
            >
              COMPANY
            </p>
          </div>
        ...
        <div
          ...
          className={`Third common-btn-style `}
        >
          <span className="saveAddress"> Save Address</span>
        </div>
      </div>
    </div>
  );
